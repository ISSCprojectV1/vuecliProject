  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logo topbar-btn">
        <a href="/"><img src="../../assets/part3/seu.png" style="padding-left:8px;"></a>
      </div>
      <div class="topbar-logos">
        <a href="/" style="color: #fff;"><span v-show="!$store.state.collapsed">大宗商品交易平台</span></a>
      </div>
      <div class="topbar-title">
        ...
        <el-row v-show="$store.state.topNavState==='home'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              ...
              <el-menu-item index="/incentiveMechanism">激励机制</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
        
        <!-- 激励机制 第二层顶栏菜单 -->
          <el-row v-show="$store.state.topNavState==='incentive'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/incentiveMechanism">上传中心</el-menu-item>
              <el-menu-item index="/statisticalCenter">统计中心</el-menu-item>
              ...
              <el-menu-item index="/download">下载数据</el-menu-item>
               ...
               <!-- 激励机制 第二层顶栏菜单 -->
          <el-row v-show="$store.state.topNavState==='download'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/incentiveMechanism">上传中心</el-menu-item>
              <el-menu-item index="/statisticalCenter">统计中心</el-menu-item>
        ...
        <!-- 激励机制 第二层统计中心 顶栏菜单 -->
          <el-row v-show="$store.state.topNavState==='statistical'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/incentiveMechanism">上传中心</el-menu-item>
              <el-menu-item index="/statisticalCenter">统计中心</el-menu-item>
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <div @click="jumpTo('/personal/index')"><span style="color: #555;font-size: 14px;">个人信息</span></div>
            </el-dropdown-item>
            <el-dropdown-item>
