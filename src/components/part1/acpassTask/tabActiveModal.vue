    ...
    <el-container style="width: 100%">
      <el-aside style="width: 580px">
        <el-table :data="dataTableActive" highlight-current-row @row-click="onClickTableActive">
          <el-table-column prop="company" label="交易主体" width="120"></el-table-column>
          <el-table-column prop="category" label="商品类型" width="80"></el-table-column>
          <el-table-column prop="abnormalValue" label="异常值" width="70">
          ...
          <el-table-column label="信用评分" width="80">80</el-table-column>
          <el-table-column label="详细信息" fixed="right" width="130">
            <template slot-scope="scope">
      ...
      <el-container style="width: 600px;">
        <el-main style="padding-top: 0">
          <div id="tableCompanyDetail" style="width: 100%; height: 100%">
            <el-table :data="dataTableDetail" style="width: 600px;">
              <el-table-column prop="seller" label="主要交易卖方" min-width="150"></el-table-column>
...
export default {
  ...
  methods: {
    // table active group
    queryActiveGroup(taskId, currentPage = 1, pageSize = 10) {
      getActiveGroup(taskId, currentPage, pageSize).then(res => {
        ...
        console.log(this.dataTableActive)
    ...
    onPageChangeActive(page) {
      const id = this.$router.currentRoute.params.id;
      this.queryActiveGroup(id, page, 10);
    },
