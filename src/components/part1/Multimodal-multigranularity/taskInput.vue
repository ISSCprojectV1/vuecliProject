...
<script>
import {taskInput,bourseget,getcommodityRelationdetails2,getcommodityTimeadvise2,getplatform,getrecommendrlatform,updateCommodity} from "@/api/part1/Multimodal-multigranularity";
