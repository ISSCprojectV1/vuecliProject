    ...
    <el-row :gutter="60" class="panel-group">
      <el-col :xs="24" :sm="24" :lg="24" class="graph-panel-col">
        <div class="form_bar_panel">
          <div style="width: calc(75% - 17px);height: calc(100% - 44px);float: left;margin: 20px 3px 20px 10px;border:#7a98b2 solid 2px;">
            <!--表单-->
            <div class="form_panel" style="width: calc(25% - 10px);height: 310px;float: left;margin: 20px 5px 10px 5px;">
            ...
            <!--柱状图-->
            <div class="bar_panel" style="width: calc(75% - 7px);height: 320px;float: left;margin: 10px 7px 10px 0;">
              <div>
          ...
          <!--饼图-->
          <div class="pie_panel" style="width: calc(25% - 24px);height: calc(100% - 44px);float: left;margin: 20px 10px 20px 10px;border:#7a98b2 solid 2px;">
...
export default {
  ...
  methods: {
    ...
    getAlldate(startdate,enddate)
    {
      ...
      let endTime=new Date(enddate.getFullYear(),enddate.getMonth(),enddate.getDate());
