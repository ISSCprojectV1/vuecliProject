      ...
      <div style="height: 100%;width: 100%; background: #cbdaea;border: #121313 solid 2px;">
        <el-form ref="form" :model="form" label-width="15%">
          <el-form-item label="关键词" >
            <el-input v-model="form.keyword" placeholder="请输入事件关键词" style="float: right;width: 80%;margin-right: 15%;border: #121313 solid 2px;border-radius: 5px"></el-input>
          </el-form-item>
          <el-form-item label="发布平台">
            <el-select v-model="form.platform" placeholder="请选择平台"  style="float: right;width: 80%;margin-right: 15%;border: #121313 solid 2px;border-radius: 5px">
          ...
          <el-form-item label="起始日期">
            <el-date-picker type="date" placeholder="选择日期" v-model="form.startdate" style="float: right;width: 80%;margin-right: 15%;border: #121313 solid 2px;border-radius: 5px"></el-date-picker>
          </el-form-item>
          <el-form-item label="终止日期">
            <el-date-picker type="date" placeholder="选择日期" v-model="form.enddate" style="float: right;width: 80%;margin-right: 15%;border: #121313 solid 2px;border-radius: 5px"></el-date-picker>
          </el-form-item>
          <el-form-item label="交易所名" >
            <el-select v-model="form.exchangename" placeholder="请选择交易所" style="float: right;width: 80%;margin-right: 15%;border: #121313 solid 2px;border-radius: 5px">
