                    ...
                    <el-tab-pane label="已发布">
                        <el-table :data="formReleased">
                            ...
                            <el-table-column label="操作" min-width="80">
                                <template slot-scope="scope">
                                    <el-button type="text" class="el-option-in-table" @click="goToVolumePage(scope.row)">监控</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-tab-pane>
...
<script>
  ...
  import {getVolumeInfoByStatus, updateVolumeInfo} from "@/api/part1/riskPrediction";
  /*
      <el-table-column label="操作" min-width="80">
                </el-table-column>
        <el-table-column label="操作" min-width="80">
  ...
  * */
  export default {
    ...
    methods: {
      ...
      getRiskInfo(status) {
        getVolumeInfoByStatus(status).then(res => {
          switch (status) {
            case 0:
      ...
      modifyInfo() {
        ...
        updateVolumeInfo(this.formRowSelected).then(() => {
          this.$message({
            message: '修改成功',
            type: 'success'
          })
