<template>
  <div>
    <el-button type="primary" @click="dialogFormAddInit" style="margin-bottom: 1rem">新增</el-button>
    <el-table
        :data="tableData"
        row-key="id"
        border
    ...
    >
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button size="mini" @click="dialogFormUpdateInit(scope.row)" style="margin-right: 0.5rem">修改</el-button>
          <el-popconfirm
