let routes = [
  ...
  //*****************************************************************************
  {
    ...
    children:[
      ...
      {
        path:"/trade/PublicOpinionsRisk/NewInterfaces/opinions_main",
      ...
      {
        path:"/trade/PublicOpinionsRisk/NewInterfaces/opinions_risk",
      ...
      {
        path:"/trade/PublicOpinionsRisk/NewInterfaces/opinions_details",
